...
test.describe("Button regression", () => {
  test("primary button (Default story) renders the primary background color", async ({
    ...
    await page.goto(
      "/iframe.html?id=components-button-standard--default"
    );
  ...
  test("secondary button renders secondary background color", async ({
    ...
    await page.goto(
      "/iframe.html?id=components-button-standard--secondary"
    );
    const button = page
  ...
  test("unstyled disabled button has transparent background and no border", async ({
    ...
    await page.goto(
      "/iframe.html?id=components-button-standard--unstyled"
    );
    const button = page.locator("button[disabled]").first();
    await expect(button).toBeVisible();
