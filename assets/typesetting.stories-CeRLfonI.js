import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<h6>Line length</h6>
<p>
  <strong>72ex max-width:</strong>
  Yosemite National Park is set within California’s Sierra Nevada mountains.
  It’s famed for its giant, ancient sequoias, and for Tunnel View, the iconic
  vista of towering Bridalveil Fall and the granite cliffs of El Capitan and
  Half Dome.
</p>
...
<div class="grid-row">
  <div class="grid-col-auto">
    <h6>Spacing</h6>
    <div class="example-spacing bg-primary-lighter">
      <h1>Page heading</h1>
      <p class="usa-intro">
...
`})))()}var r,i,a;function o(){return(o=e((()=>{n(),r={title:`Branding/Typography/Typesetting`},i=()=>t,i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`() => {
  return Typesettings;
}`,...i.parameters?.docs?.source}}},a=[`Typesetting`]})))()}o();export{i as Typesetting,a as __namedExportsOrder,r as default};