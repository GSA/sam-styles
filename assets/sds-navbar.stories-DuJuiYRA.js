import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<div class="sds-navbar border-bottom border-base-lighter">
  <div class="sds-navbar__content">
    <div class="grid-row">
      ...
      <div
        class="grid-col-12 tablet-lg:grid-col-fill display-flex flex-align-center"
      >
        <div class="tablet-lg:order-1">
          <!-- Buttons -->
          <button class="usa-button usa-button--secondary">Button</button>
          <button class="usa-button margin-top-05 tablet:margin-top-0">
            Button
          </button>
        </div>
        <div class="flex-fill">
          <!-- Search -->
          <form
            class="usa-search usa-search--small margin-x-105 margin-top-05 tablet:margin-top-0"
          >
            <div role="search">
              <label class="usa-sr-only" for="search-field-small">Search</label>
              <input
                class="usa-input width-card-lg widescreen:width-mobile display-none desktop-lg:display-inline-block"
...
`})))()}var r;function i(){return(i=e((()=>{r=`<!-- Minimal fixture for testing subheader action-button variants (issue #743).
...
`})))()}var a,o,s,c;function l(){return(l=e((()=>{n(),i(),a={title:`Structure/SDS-Navbar`},o=()=>t,s=()=>r,o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
  return NavBar;
}`,...o.parameters?.docs?.source}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  return SubheaderActions;
}`,...s.parameters?.docs?.source}}},c=[`SDSNavbar`,`SDSSubheaderActions`]})))()}l();export{o as SDSNavbar,s as SDSSubheaderActions,c as __namedExportsOrder,a as default};