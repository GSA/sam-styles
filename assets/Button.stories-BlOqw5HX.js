import{r as e}from"./preload-helper-Dl2UHooj.js";var t,n=e((()=>{t=`<table class="sds-table">
  <tr>
    <th>
...
`})),a,o=e((()=>{a=`<div class="bg-base-darkest padding-4">
  <div class="grid-row">
    <div class="grid-col">
      <div class="padding-y-2">
...
`})),s,c=e((()=>{s=`<div class="bg-base-lightest padding-4">
  <div class="grid-row">
    <div class="grid-col">
      <div class="padding-y-2">
...
`})),d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{n(),i(),o(),c(),u(),d={title:`Components/Button/Standard`,argTypes:{label:{control:`text`},type:{control:{type:`select`},options:[`primary`,`secondary`,`base`,`unstyled`,`accent-cool`,`outline`,`shadow`]},size:{control:{type:`select`},options:[``,`big`,`small`]},color:{control:{type:`select`},options:[``,`light`,`lighter`,`lightest`,`vivid`,`dark`,`darker`]}}},f=e=>{var t=``;e.size&&(t=e.size===`small`?`sds-button--small`:`usa-button--${e.size}`);var n=``;e.type&&(n=e.type===`danger`?`sds-button--danger`:`usa-button--${e.type}`);let r=e.type?e.type:`primary`,i=e.type&&e.color?`bg-${r}-${e.color}`:``;return`<button
    type="button"
    class="usa-button ${n} ${t} ${i}"
    >${e.label}</button
>
<button
    type="button"
    class="usa-button ${n} ${t} ${i} usa-button--hover"
    >Hover</button
>
<button
    type="button"
    class="usa-button ${n} ${t} ${i} usa-button--active"
    >Active</button
>
<button
    type="button"
    class="usa-button ${n} ${t} ${i} usa-focus"
    >Focus</button
>
...
disabled="disabled"
    >Disabled</button
>
`},p=()=>t,m=()=>r,h=()=>a,g=()=>s,_=()=>l,v=f.bind({}),v.args={label:`Default`},y=f.bind({}),y.args={label:`Secondary`,type:`secondary`},b=f.bind({}),b.args={label:`Accent`,type:`accent-cool`},x=f.bind({}),x.args={label:`Base`,type:`base`},S=f.bind({}),S.args={label:`Small`,size:`small`},C=f.bind({}),C.args={label:`Big`,size:`big`},w=f.bind({}),w.args={label:`Outline`,type:`outline`},T=f.bind({}),T.args={label:`Danger`,type:`danger`},E=f.bind({}),E.args={label:`Unstyled`,type:`unstyled`},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`() => {
...
>
\`;
}`,...E.parameters?.docs?.source}}},D=[`Variants`,`OutlineSecondary`,`OutlineInverse`,`White`,`Shadow`,`Default`,`Secondary`,`AccentCool`,`Base`,`Small`,`Big`,`Outline`,`Danger`,`Unstyled`]}))();export{b as AccentCool,x as Base,C as Big,T as Danger,v as Default,w as Outline,h as OutlineInverse,m as OutlineSecondary,y as Secondary,_ as Shadow,S as Small,E as Unstyled,p as Variants,g as White,D as __namedExportsOrder,d as default};