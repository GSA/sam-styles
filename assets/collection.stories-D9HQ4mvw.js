import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<ul class="usa-collection">
...
`})))()}var r;function i(){return(i=e((()=>{r=`<ul class="usa-collection">
  <li class="usa-collection__item">
    <img
...
`})))()}var a;function o(){return(o=e((()=>{a=`<ul class="usa-collection">
  <li class="usa-collection__item">
    <div
...
`})))()}var s;function c(){return(c=e((()=>{s=`<ul class="usa-collection usa-collection--condensed">
  <li class="usa-collection__item">
    <div class="usa-collection__body">
      <h3 class="usa-collection__heading">
        <a
...
`})))()}var l,u,d,f,p,m;function h(){return(h=e((()=>{n(),i(),o(),c(),l={title:`Components/Collection`},u=()=>t,d=()=>r,f=()=>a,p=()=>s,u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`() => {
...
}`,...p.parameters?.docs?.source}}},m=[`Default`,`Media`,`Calender`,`Condensed`]})))()}h();export{f as Calender,p as Condensed,u as Default,d as Media,m as __namedExportsOrder,l as default};