const n={title:"Components/Actions"},t=()=>`<div class="grid-row bg-accent-warm-lighter">
  ...
  `,s=t.bind({});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...s.parameters?.docs?.source}}};const i=["Actions"];export{s as Actions,i as __namedExportsOrder,n as default};
