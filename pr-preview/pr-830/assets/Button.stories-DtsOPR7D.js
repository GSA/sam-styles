...
`})))()}var r;function i(){return(i=e((()=>{r=`<div class="padding-4">
  <div class="grid-row">
    <div class="grid-col">
...
`})))()}var a;function o(){return(o=e((()=>{a=`<div class="bg-base-darkest padding-4">
  <div class="grid-row">
    <div class="grid-col">
      <div class="padding-y-2">
...
`})))()}var s;function c(){return(c=e((()=>{s=`<div class="bg-base-lightest padding-4">
  <div class="grid-row">
    <div class="grid-col">
      <div class="padding-y-2">
...
`})))()}var l;function u(){return(u=e((()=>{l=`<div class="padding-4">
  <div class="grid-row">
    <div class="grid-col">
      <div class="padding-y-2">
...
`})))()}var d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{n(),i(),o(),c(),u(),d={title:`Components/Button/Standard`,argTypes:{label:{control:`text`},type:{control:{type:`select`},options:[`primary`,`secondary`,`base`,`unstyled`,`accent-cool`,`outline`,`shadow`]},size:{control:{type:`select`},options:[``,`big`,`small`]},color:{control:{type:`select`},options:[``,`light`,`lighter`,`lightest`,`vivid`,`dark`,`darker`]}}},f=e=>{var t=``;e.size&&(t=e.size===`small`?`sds-button--small`:`usa-button--${e.size}`);var n=``;e.type&&(n=e.type===`danger`?`sds-button--danger`:`usa-button--${e.type}`);let r=e.type?e.type:`primary`,i=e.type&&e.color?`bg-${r}-${e.color}`:``;return`<button
    type="button"
