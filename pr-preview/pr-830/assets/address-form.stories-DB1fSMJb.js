import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t,n,r,i;function a(){return(a=e((()=>{t={title:`Form Elements/AddressForm`,argTypes:{label:{type:`string`},classTypes:{control:{type:`select`},options:[``,`usa-focus`,`usa-input--error`,`usa-input--success`]}}},n=e=>` 
  ...
  `,r=n.bind({}),r.args={label:`Text input label`},i=[`AddressForm`]})))()}a();export{r as AddressForm,i as __namedExportsOrder,t as default};