import{r as e}from"./preload-helper-Dl2UHooj.js";var t,n,r,i;e((()=>{t={title:`Form Elements/NameForm`,argTypes:{label:{type:`string`},classTypes:{control:{type:`select`},options:[``,`usa-focus`,`usa-input--error`,`usa-input--success`]}}},n=e=>` 
    <form class="usa-form">
  ...
  return \` 
    ...
    \`;
}`,...r.parameters?.docs?.source}}},i=[`NameForm`]}))();export{r as NameForm,i as __namedExportsOrder,t as default};