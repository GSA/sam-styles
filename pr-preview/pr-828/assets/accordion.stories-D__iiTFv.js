import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<div
...
`})))()}var r,i,a,o,s;function c(){return(c=e((()=>{n(),r={title:`Components/Accordion`,argTypes:{class:{type:`string`},expanded:{type:`boolean`}}},i=e=>`<div class="usa-accordion ${e.class}">
...
</div>`,a=()=>t,o=i.bind({}),o.args={class:`usa-accordion--bordered`},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`() => {
...
}`,...o.parameters?.docs?.source}}},s=[`Multiselectable`,`Bordered`]})))()}c();export{o as Bordered,a as Multiselectable,s as __namedExportsOrder,r as default};