import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<h2>Chips</h2>
...
`})))()}var r;function i(){return(i=e((()=>{r=`<span class="usa-tag">New</span>
...
<span
  ...
  >SAM</span
>
`})))()}var a;function o(){return(o=e((()=>{a=`<h2>Status</h2>\r
\r
...
</div>`})))()}var s;function c(){return(c=e((()=>{s=`<h3>Outline Options</h3>
...
`})))()}var l;function u(){return(u=e((()=>{l=`<p>
...
`})))()}var d;function f(){return(f=e((()=>{d=`<h2>Status tags:</h2>
...
`})))()}var p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{n(),i(),o(),c(),u(),f(),p={title:`Components/Tags`},m=()=>r,h=()=>t,g=()=>a,_=()=>s,v=()=>l,y=()=>d,m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => {
  return info;
  ...
  return statusTag;
}`,...y.parameters?.docs?.source}}},b=[`Info`,`Chips`,`Status`,`OutlinedSam`,`OutlinedExtended`,`StatusTag`]})))()}x();export{h as Chips,m as Info,v as OutlinedExtended,_ as OutlinedSam,g as Status,y as StatusTag,b as __namedExportsOrder,p as default};