const t=`<div class="sds-pagination">
...
`,s={title:"Components/Pagination"},n=()=>t;n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  return Head;
}`,...n.parameters?.docs?.source}}};const e=["Pagination"];export{n as Pagination,e as __namedExportsOrder,s as default};
