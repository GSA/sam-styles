const a=`<div class="sds-navbar border-bottom border-base-lighter">
...
`,s=`<!-- Minimal fixture for testing subheader action-button variants (issue #743).
...
`,e={title:"Structure/SDS-Navbar"},n=()=>a,t=()=>s;n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  return NavBar;
}`,...n.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  return SubheaderActions;
}`,...t.parameters?.docs?.source}}};const i=["SDSNavbar","SDSSubheaderActions"];export{n as SDSNavbar,t as SDSSubheaderActions,i as __namedExportsOrder,e as default};
