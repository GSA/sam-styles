const d={title:"Miscellaneous/SearchLayout"},a=()=>`<div class="margin-3 grid-row grid-gap">
  ...
  \`;
}`,...s.parameters?.docs?.source}}};const i=["SearchLayout"];export{s as SearchLayout,i as __namedExportsOrder,d as default};
