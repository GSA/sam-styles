import{r as e}from"./preload-helper-Dl2UHooj.js";var t,n=e((()=>{t=`<h2>Chips</h2>
...
`})),r,i=e((()=>{r=`<span class="usa-tag">New</span>
...
</div>`})),s,c=e((()=>{s=`<h3>Outline Options</h3>
...
`})),p,m,h,g,_,v,y,b;e((()=>{n(),i(),o(),c(),u(),f(),p={title:`Components/Tags`},m=()=>r,h=()=>t,g=()=>a,_=()=>s,v=()=>l,y=()=>d,m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`() => {
  return info;
  ...
  return statusTag;
}`,...y.parameters?.docs?.source}}},b=[`Info`,`Chips`,`Status`,`OutlinedSam`,`OutlinedExtended`,`StatusTag`]}))();export{h as Chips,m as Info,v as OutlinedExtended,_ as OutlinedSam,g as Status,y as StatusTag,b as __namedExportsOrder,p as default};