...
`})),l,u,d,f,p,m;e((()=>{n(),i(),o(),c(),l={title:`Components/Button/Pill`},u=()=>s,d=()=>t,f=()=>r,p=()=>a,u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`() => {
...
}`,...p.parameters?.docs?.source}}},m=[`Variants`,`Next`,`Cancel`,`Previous`]}))();export{f as Cancel,d as Next,p as Previous,u as Variants,m as __namedExportsOrder,l as default};