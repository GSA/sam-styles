import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t;function n(){return(n=e((()=>{t=`<footer class="usa-footer usa-footer--big" role="contentinfo">
  <div class="sds-feedback">
    ...
    >
      <i class="sds text-ink fa-arrow-down sds-feedback__open"></i>
    ...
    >
      <div>
        ...
        <label for="feedback" class="sds-feedback__response-text"
          >What changes or improvements would you suggest?</label
        >
        <textarea id="feedback" class="sds-feedback__input" rows="8"></textarea>
        <p class="text-right button-width">
          <button class="usa-button bg-primary-light usa-focus">Submit</button>
        </p>
      </div>
    </div>
  </div>
  <div class="usa-footer__primary-section">
    <div
      class="grid-container margin-x-0 mobile-lg:margin-x-auto padding-x-0 mobile-lg:padding-x-auto"
    >
      <div class="grid-row grid-gap-0 mobile-lg:grid-gap">
        <div class="tablet:grid-col-12">
          <nav
            class="usa-footer__nav margin-x-0 mobile-lg:margin-x-2 padding-x-0 mobile-lg:padding-x-2"
          >
      ...
      <div class="grid-row grid-gap">
        ...
        >
          <div class="sds-footer__logo">
            <a class="sds-footer__logo-link" href="javascript:void(0);">
              <img src="../../../images/logo-img.png" alt="Agency Logo" />
            </a>
            <h3 class="sds-footer__logo-heading">Name of Agency</h3>
          </div>
        </div>
        <div
...
`})))()}var r;function i(){return(i=e((()=>{r=`<footer class="usa-footer usa-footer--big" role="contentinfo">
  <div class="sds-feedback">
    <h2 class="sr-only">Feedback</h2>
    <button
      type="button"
      ...
      (click)="isCollapsedContent = !isCollapsedContent"
    >
      <i class="sds text-ink sds-feedback__open"></i>
      <span class="sds-feedback__title">Feedback</span>
    </button>
    <div
      id="collapseID"
            ...
            <div class="grid-row grid-gap-0 mobile-lg:grid-gap-4">
              <div class="mobile-lg:grid-col-6 desktop:grid-col-3">
                <section
                  class="usa-footer__primary-content usa-footer__primary-content--collapsible"
                >
                  <h4 class="usa-footer__primary-link">About This Site</h4>
                  <ul class="usa-list usa-list--unstyled">
                    <li class="usa-footer__secondary-link">
              ...
              <div class="mobile-lg:grid-col-6 desktop:grid-col-3">
                <section
                  class="usa-footer__primary-content usa-footer__primary-content--collapsible"
                >
                  <h4 class="usa-footer__primary-link">Our Partners</h4>
                  <ul class="usa-list usa-list--unstyled">
                    <li class="usa-footer__secondary-link">
              ...
              <div class="mobile-lg:grid-col-6 desktop:grid-col-3">
                <section
                  class="usa-footer__primary-content usa-footer__primary-content--collapsible"
                >
                  <h4 class="usa-footer__primary-link">Customer Service</h4>
                  <ul class="usa-list usa-list--unstyled">
                    <li class="usa-footer__secondary-link">
                      <a href="javascript:void(0);">Help</a>
                    </li>
                    <li class="usa-footer__secondary-link">
                      <a href="javascript:void(0);">Check Entity Status</a>
                    </li>
                    <li class="usa-footer__secondary-link">
                      <a href="javascript:void(0);">Federal Service Desk</a>
                    </li>
                    <li class="usa-footer__secondary-link">
                      <a href="javascript:void(0);">External Resources</a>
                    </li>
                    <li class="usa-footer__secondary-link">
    ...
    <div class="grid-container">
      <div class="grid-row grid-gap">
        ...
        >
          <div class="sds-footer__logo">
            <a class="sds-footer__logo-link" href="javascript:void(0);">
              <img src="../../../images/logo-gsa.svg" alt="GSA Logo" />
            </a>
...
`})))()}var a,o,s,c;function l(){return(l=e((()=>{n(),i(),a={title:`Structure/Footer`},o=()=>t,s=()=>r,o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`() => {
  return DefaultBigFooter;
}`,...o.parameters?.docs?.source}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  return GsaBigFooter;
}`,...s.parameters?.docs?.source}}},c=[`DefaultBig`,`GsaBig`]})))()}l();export{o as DefaultBig,s as GsaBig,c as __namedExportsOrder,a as default};