const l={title:"Components/History"},i=()=>`<ul class="sds-history">
    <li>
  ...
  `,s=i.bind({});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...s.parameters?.docs?.source}}};const a=["History"];export{s as History,a as __namedExportsOrder,l as default};
