const i={title:"Form Elements/AddressForm",argTypes:{label:{type:"string"},classTypes:{control:{type:"select"},options:["","usa-focus","usa-input--error","usa-input--success"]}}},n=a=>` 
  ...
  `,o=n.bind({});o.args={label:"Text input label"};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`args => {
  return \` 
    <div class="sds-form-wrapper grid-row">
    <form class="sds-form usa-form usa-form--large">
        <fieldset class="usa-fieldset">
  ...
  \`;
}`,...o.parameters?.docs?.source}}};const e=["AddressForm"];export{o as AddressForm,e as __namedExportsOrder,i as default};
