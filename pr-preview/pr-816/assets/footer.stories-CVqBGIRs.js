const a=`<footer class="usa-footer usa-footer--big" role="contentinfo">
...
`,i=`<footer class="usa-footer usa-footer--big" role="contentinfo">
  <div class="sds-feedback">
    <h2 class="sr-only">Feedback</h2>
    <button
      type="button"
...
`,o={title:"Structure/Footer"},s=()=>a,n=()=>i;s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  return DefaultBigFooter;
}`,...s.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`() => {
  return GsaBigFooter;
}`,...n.parameters?.docs?.source}}};const e=["DefaultBig","GsaBig"];export{s as DefaultBig,n as GsaBig,e as __namedExportsOrder,o as default};
