const n={title:"Components/ButtonRow"},s=()=>`<h2>Button Row</h2>
  ...
  `,t=s.bind({});t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...t.parameters?.docs?.source}}};const a=["Default"];export{t as Default,a as __namedExportsOrder,n as default};
