import{r as e}from"./preload-helper-Dl2UHooj.js";var t,n,r,i;e((()=>{t={title:`Form Elements/AddressForm`,argTypes:{label:{type:`string`},classTypes:{control:{type:`select`},options:[``,`usa-focus`,`usa-input--error`,`usa-input--success`]}}},n=e=>` 
  ...
  \`;
}`,...r.parameters?.docs?.source}}},i=[`AddressForm`]}))();export{r as AddressForm,i as __namedExportsOrder,t as default};