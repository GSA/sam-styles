import{r as e}from"./preload-helper-Dl2UHooj.js";var t,n=e((()=>{t=`<ul class="usa-collection">
...
`})),r,i=e((()=>{r=`<ul class="usa-collection">
  <li class="usa-collection__item">
    <img
...
`})),a,o=e((()=>{a=`<ul class="usa-collection">
  <li class="usa-collection__item">
    <div
...
`})),s,c=e((()=>{s=`<ul class="usa-collection usa-collection--condensed">
  <li class="usa-collection__item">
    <div class="usa-collection__body">
      <h3 class="usa-collection__heading">
        <a
...
`})),l,u,d,f,p,m;e((()=>{n(),i(),o(),c(),l={title:`Components/Collection`},u=()=>t,d=()=>r,f=()=>a,p=()=>s,u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`() => {
...
}`,...p.parameters?.docs?.source}}},m=[`Default`,`Media`,`Calender`,`Condensed`]}))();export{f as Calender,p as Condensed,u as Default,d as Media,m as __namedExportsOrder,l as default};