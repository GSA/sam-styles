import{t as e}from"./rolldown-runtime-Dh6celcD.js";var t,n,r,i;function a(){return(a=e((()=>{t={title:`Form Elements/Input`,argTypes:{label:{type:`string`},classTypes:{control:{type:`select`},options:[``,`usa-focus`,`usa-input--error`,`usa-input--success`]}}},n=e=>` 
  <form class="usa-form">
...
`,r=n.bind({}),r.args={label:`Text input label`},i=[`Input`]})))()}a();export{r as Input,i as __namedExportsOrder,t as default};