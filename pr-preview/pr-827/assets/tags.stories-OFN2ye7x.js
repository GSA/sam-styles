...
`})))()}var p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{n(),i(),o(),c(),u(),f(),p={title:`Components/Tags`},m=()=>r,h=()=>t,g=()=>a,_=()=>s,v=()=>l,y=()=>d,b=[`Info`,`Chips`,`Status`,`OutlinedSam`,`OutlinedExtended`,`StatusTag`]})))()}x();export{h as Chips,m as Info,v as OutlinedExtended,_ as OutlinedSam,g as Status,y as StatusTag,b as __namedExportsOrder,p as default};