const o={title:"SDS Styles/Overrides"},e=()=>`
...
`;e.storyName="Menu button (sds-button--menu)";const t=()=>`
  <style>
...
`;t.storyName="Horizontal filter layout (sds-filters--horizontal)";const s=()=>`
...
`;s.storyName="Slideout panel (dialog-slide-out)";e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => \`
  <div class="grid-row grid-gap padding-2 bg-accent-warm-lighter">
    <div class="tablet:grid-col">
      <h4>.sds-button--menu</h4>
      <p class="font-sans-3xs text-base">
...
\``,...s.parameters?.docs?.source}}};const n=["MenuButton","HorizontalFilter","Slideout"];export{t as HorizontalFilter,e as MenuButton,s as Slideout,n as __namedExportsOrder,o as default};
