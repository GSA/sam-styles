const t={title:"Form Elements/Input",argTypes:{label:{type:"string"},classTypes:{control:{type:"select"},options:["","usa-focus","usa-input--error","usa-input--success"]}}},s=a=>` 
  <form class="usa-form">
...
`,e=s.bind({});e.args={label:"Text input label"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`args => {
  return \` 
  <form class="usa-form">
    <label class="usa-label" for="input-type-text">Text input label</label>
    <input class="usa-input" id="input-type-text" name="input-type-text" type="text">
...
\`;
}`,...e.parameters?.docs?.source}}};const u=["Input"];export{e as Input,u as __namedExportsOrder,t as default};
