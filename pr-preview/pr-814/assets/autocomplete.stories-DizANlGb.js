const l={title:"Components/AutoComplete"},e=()=>`<ul class="sds-autocomplete sds-list--no-bullets" role="listbox">
  ...
  `,s=e.bind({});s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...s.parameters?.docs?.source}}};const t=["AutoComplete"];export{s as AutoComplete,t as __namedExportsOrder,l as default};
